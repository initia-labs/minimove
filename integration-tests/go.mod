module github.com/initia-labs/minimove/integration-tests
...
// initia custom
replace (
	github.com/cometbft/cometbft => github.com/initia-labs/cometbft v0.38.19-minitia.24
...
// local import
replace github.com/initia-labs/minimove => ../
